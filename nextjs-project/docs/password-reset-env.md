...
Без настроенного SMTP запрос «Забыли пароль» сначала пробует отправить ссылку
в привязанный Telegram/MAX. Если и мессенджеры недоступны — вернётся ошибка;
админ может выдать ссылку вручную: **Пользователи → иконка ключа**
