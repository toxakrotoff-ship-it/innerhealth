...
export function AccountMaxBlock({ brandId }: { brandId: BrandId }) {
      ...
      {status?.linked ? (
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-green-700">
                  Вы будете получать статусы оплаты заказа и трек-номер CDEK (когда он появится).
                </p>
                {status.linkedAt && (
        ...
        <>
          <p className="text-gray-600 text-sm mb-4">
            Подключите MAX, чтобы получать статусы оплаты заказа и трек-номер CDEK (когда он появится).
          </p>
          {linkResult ? (
            <div className="space-y-3">
