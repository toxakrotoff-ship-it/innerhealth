...
export default function AdminTildaLeadsPage() {
  ...
  return (
    <div className="admin-container">
      <div className="admin-content">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Заявки с Тильды</h1>
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    {!orderItems?.length && (lead.input || lead.input2) && (
                                      <p className="text-gray-500 text-xs">
                                        Если здесь не состав заказа — в экспорте Тильды его может не быть. Проверьте в личном кабинете Тильды: в карточке лида отображается заказ. Либо настройте форму так, чтобы корзина уходила в одно из полей (например JSON в Input).
                                      </p>
                                    )}
                                    {lead.review && (
                                      <div>
