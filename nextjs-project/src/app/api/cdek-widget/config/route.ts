    ...
    return NextResponse.json(
      {
        ...
        tariffs: {
          ...
          // (сдаём сами на склад СДЭК, без курьерского забора у отправителя).
          // office = "до ПВЗ" (склад-склад / эконом склад-склад)
          // door = "до двери" (склад-дверь / эконом склад-дверь)
          // Второй код в каждой паре — экономичный fallback: не все ПВЗ/маршруты
          // поддерживают основной тариф, без запасного варианта расчёт стоимости
          // для части точек выдачи молча не срабатывает.
          office: [136, 234],
          door: [137, 233],
        },
      },
