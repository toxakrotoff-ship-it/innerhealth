...
const INNER_HOME_ADMIN_SCHEMA: readonly AdminContentBlockSchemaEntry[] = [
  ...
  { page: 'home', key: 'hero.description' },
  { page: 'home', key: 'hero.cta.label' },
  { page: 'home', key: 'hero.cta.href' },
  { page: 'home', key: 'hero.image.src' },
  { page: 'home', key: 'hero.image.alt' },
  { page: 'home', key: 'hero.isVisible', adminLabel: 'Hero — показывать блок (1 / да / on)' },
  { page: 'home', key: 'hero.badge.isVisible', adminLabel: 'Hero — показывать бейдж (1 / да / on)' },
  { page: 'home', key: 'hero.subtitle.isVisible', adminLabel: 'Hero — показывать подзаголовок (1 / да / on)' },
  ...
  { page: 'home', key: 'home.directions.cta.href' },
  { page: 'home', key: 'home.directions.item1.title' },
  { page: 'home', key: 'home.directions.item1.description' },
  { page: 'home', key: 'home.directions.item1.categorySlug', adminLabel: 'Направление 1 — категория' },
  { page: 'home', key: 'home.directions.item1.href' },
  { page: 'home', key: 'home.directions.item1.image.src' },
  { page: 'home', key: 'home.directions.item1.image.alt' },
  { page: 'home', key: 'home.directions.item1.sortOrder', adminLabel: 'Направление 1 — порядок' },
  { page: 'home', key: 'home.directions.item1.isVisible', adminLabel: 'Направление 1 — показывать (1 / да / on)' },
  { page: 'home', key: 'home.directions.item2.title' },
  { page: 'home', key: 'home.directions.item2.description' },
  { page: 'home', key: 'home.directions.item2.categorySlug', adminLabel: 'Направление 2 — категория' },
  { page: 'home', key: 'home.directions.item2.href' },
  { page: 'home', key: 'home.directions.item2.image.src' },
  { page: 'home', key: 'home.directions.item2.image.alt' },
  { page: 'home', key: 'home.directions.item2.sortOrder', adminLabel: 'Направление 2 — порядок' },
  { page: 'home', key: 'home.directions.item2.isVisible', adminLabel: 'Направление 2 — показывать (1 / да / on)' },
  { page: 'home', key: 'home.directions.item3.title' },
  { page: 'home', key: 'home.directions.item3.description' },
  { page: 'home', key: 'home.directions.item3.categorySlug', adminLabel: 'Направление 3 — категория' },
  { page: 'home', key: 'home.directions.item3.href' },
  { page: 'home', key: 'home.directions.item3.image.src' },
  { page: 'home', key: 'home.directions.item3.image.alt' },
  { page: 'home', key: 'home.directions.item3.sortOrder', adminLabel: 'Направление 3 — порядок' },
  { page: 'home', key: 'home.directions.item3.isVisible', adminLabel: 'Направление 3 — показывать (1 / да / on)' },
...
const CONTACTS_ADMIN_SCHEMA: readonly AdminContentBlockSchemaEntry[] = [
  ...
  { page: 'contacts', key: 'contacts.section.showroom_note' },
...
const CERTIFICATES_ADMIN_SCHEMA: readonly AdminContentBlockSchemaEntry[] = [
  ...
  { page: 'certificates', key: 'certificates.gallery.image7.src' },
  { page: 'certificates', key: 'certificates.gallery.image7.alt' },
  { page: 'certificates', key: 'certificates.gallery.image8.src' },
  { page: 'certificates', key: 'certificates.gallery.image8.alt' },
  { page: 'certificates', key: 'certificates.gallery.image9.src' },
  { page: 'certificates', key: 'certificates.gallery.image9.alt' },
  { page: 'certificates', key: 'certificates.gallery.image10.src' },
  { page: 'certificates', key: 'certificates.gallery.image10.alt' },
  { page: 'certificates', key: 'certificates.gallery.image11.src' },
  { page: 'certificates', key: 'certificates.gallery.image11.alt' },
...
export const CONTENT_BLOCK_DEFAULTS: ContentBlockDefault[] = [
  ...
  },
  {
    ...
    type: 'short',
    text: '/hero-portrait.png',
  },
  {
    page: 'home',
    key: 'hero.image.alt',
    label: 'Hero — alt изображения',
    type: 'short',
    text: 'Иллюстрация Inner Health с фирменным героем и упаковками функционального питания.',
  },
  {
    page: 'home',
    key: 'hero.isVisible',
    label: 'Hero — показывать блок',
    type: 'short',
    text: '1',
  },
  {
    page: 'home',
    key: 'hero.badge.isVisible',
    label: 'Hero — показывать бейдж',
    type: 'short',
    text: '1',
  },
  {
    page: 'home',
    key: 'hero.subtitle.isVisible',
    label: 'Hero — показывать подзаголовок',
    type: 'short',
    text: '1',
  },
  {
    page: 'home',
    key: 'hero.description.isVisible',
    label: 'Hero — показывать описание',
    type: 'short',
    text: '1',
  },
  {
    page: 'home',
    key: 'hero.cta.isVisible',
    label: 'Hero — показывать основную кнопку',
    type: 'short',
    text: '1',
  },
  {
    page: 'home',
    key: 'hero.image.isVisible',
    label: 'Hero — показывать изображение',
    type: 'short',
    text: '1',
  },
  {
    ...
    label: 'Главная — порядок секций',
    type: 'short',
    text: 'directions,newArrivals,howToOrder,hits,articles,reviews',
  },
  {
    page: 'home',
    key: 'home.directions.title',
    label: 'Направления — заголовок',
    type: 'short',
    text: 'Товарные направления',
  },
  {
    page: 'home',
    key: 'home.directions.subtitle',
    label: 'Направления — подзаголовок',
    type: 'short',
    text: 'Три ключевых направления ассортимента Inner Health, доступные уже сейчас.',
    colorToken: 'text-slate-500',
  },
  {
    page: 'home',
    key: 'home.directions.cta.label',
    label: 'Направления — CTA текст',
    type: 'short',
    text: 'СМОТРЕТЬ ВЕСЬ КАТАЛОГ',
  },
  {
    page: 'home',
    key: 'home.directions.cta.href',
    label: 'Направления — CTA ссылка',
    type: 'short',
    text: '/catalog',
  },
  {
    page: 'home',
    key: 'home.directions.item1.title',
    label: 'Направление 1 — название',
    type: 'short',
    text: 'Натуральные бульоны',
  },
  {
    page: 'home',
    key: 'home.directions.item1.description',
    label: 'Направление 1 — описание',
    type: 'short',
    text: 'Сухие костные и мясные бульоны российского производства для ежедневного рациона и удобного приготовления.',
  },
  {
    page: 'home',
    key: 'home.directions.item1.categorySlug',
    label: 'Направление 1 — категория',
    type: 'short',
    text: 'bulony',
  },
  {
    ...
    label: 'Направление 1 — ссылка',
    type: 'short',
    text: '/catalog/bulony',
  },
  {
    page: 'home',
    key: 'home.directions.item1.image.src',
    label: 'Направление 1 — изображение',
    type: 'short',
  },
  {
    page: 'home',
    key: 'home.directions.item1.image.alt',
    label: 'Направление 1 — alt изображения',
    type: 'short',
    text: 'Натуральные сухие бульоны Inner Health.',
  },
  {
    page: 'home',
    key: 'home.directions.item1.sortOrder',
    label: 'Направление 1 — порядок',
    type: 'short',
    text: '1',
  },
  {
    page: 'home',
    key: 'home.directions.item1.isVisible',
    label: 'Направление 1 — показывать',
    type: 'short',
    text: '1',
  },
  {
    page: 'home',
    key: 'home.directions.item2.title',
    label: 'Направление 2 — название',
    type: 'short',
    text: 'Коллаген и пептиды',
  },
  {
    page: 'home',
    key: 'home.directions.item2.description',
    label: 'Направление 2 — описание',
    type: 'short',
    text: 'Пептидный коллаген в понятных форматах с подробной информацией о составе и способе применения.',
  },
  {
    page: 'home',
    key: 'home.directions.item2.categorySlug',
    label: 'Направление 2 — категория',
    type: 'short',
    text: 'collagen',
  },
  {
    page: 'home',
    key: 'home.directions.item2.href',
    label: 'Направление 2 — ссылка',
    type: 'short',
    text: '/catalog/collagen',
  },
  {
    page: 'home',
    key: 'home.directions.item2.image.src',
    label: 'Направление 2 — изображение',
    type: 'short',
  },
  {
    page: 'home',
    key: 'home.directions.item2.image.alt',
    label: 'Направление 2 — alt изображения',
    type: 'short',
    text: 'Коллаген и пептиды Inner Health.',
  },
  {
    page: 'home',
    key: 'home.directions.item2.sortOrder',
    label: 'Направление 2 — порядок',
    type: 'short',
    text: '2',
  },
  {
    page: 'home',
    key: 'home.directions.item2.isVisible',
    label: 'Направление 2 — показывать',
    type: 'short',
    text: '1',
  },
  {
    page: 'home',
    key: 'home.directions.item3.title',
    label: 'Направление 3 — название',
    type: 'short',
    text: 'Функциональные грибы',
  },
  {
    page: 'home',
    key: 'home.directions.item3.description',
    label: 'Направление 3 — описание',
    type: 'short',
    text: 'Продукты из ежовика, рейши, кордицепса и других функциональных грибов российского производства.',
  },
  {
    page: 'home',
    key: 'home.directions.item3.categorySlug',
    label: 'Направление 3 — категория',
    type: 'short',
    text: 'gribnaya-kollekciya',
  },
  {
    page: 'home',
    key: 'home.directions.item3.href',
    label: 'Направление 3 — ссылка',
    type: 'short',
    text: '/catalog/gribnaya-kollekciya',
  },
  {
    page: 'home',
    key: 'home.directions.item3.image.src',
    label: 'Направление 3 — изображение',
    type: 'short',
  },
  {
    page: 'home',
    key: 'home.directions.item3.image.alt',
    label: 'Направление 3 — alt изображения',
    type: 'short',
    text: 'Функциональные грибы Inner Health.',
  },
  {
    page: 'home',
    key: 'home.directions.item3.sortOrder',
    label: 'Направление 3 — порядок',
    type: 'short',
    text: '3',
  },
  {
    page: 'home',
    key: 'home.directions.item3.isVisible',
    label: 'Направление 3 — показывать',
    type: 'short',
    text: '1',
  },
  ...
  },
  {
    ...
    type: 'short',
    text: 'Шоурум INNER HEALTH в Москве',
  },
  {
    page: 'contacts',
    key: 'contacts.section.showroom_note',
    label: 'Контакты — примечание под заголовком шоурума',
    type: 'short',
    text: 'Посещение — только по предварительной записи.',
  },
  {
    page: 'contacts',
    ...
    type: 'short',
    text: 'Время посещения по записи:',
  },
  {
    page: 'contacts',
  ...
  },
  {
    ...
    label: 'Контакты — адрес шоурума',
    type: 'short',
    text: 'Набережная Новикова-Прибоя, д. 6, корп. 4\n2-й этаж, офис INNER HEALTH',
  },
  {
    page: 'contacts',
  ...
  },
  {
    ...
    type: 'short',
    text: 'Сб–Вс: 10:00–17:00',
  },
  {
    page: 'contacts',
    key: 'contacts.working_note',
    label: 'Контакты — примечание к режиму (опционально)',
    type: 'short',
    text: '',
  },
  ...
  {
    page: 'certificates',
    key: 'certificates.gallery.image7.src',
    label: 'Сертификаты — галерея (изображение 7 URL)',
    type: 'short',
    text: '',
  },
  {
    page: 'certificates',
    key: 'certificates.gallery.image7.alt',
    label: 'Сертификаты — галерея (изображение 7 alt)',
    type: 'short',
    text: 'Сертификат 7',
  },
  {
    page: 'certificates',
    key: 'certificates.gallery.image8.src',
    label: 'Сертификаты — галерея (изображение 8 URL)',
    type: 'short',
    text: '',
  },
  {
    page: 'certificates',
    key: 'certificates.gallery.image8.alt',
    label: 'Сертификаты — галерея (изображение 8 alt)',
    type: 'short',
    text: 'Сертификат 8',
  },
  {
    page: 'certificates',
    key: 'certificates.gallery.image9.src',
    label: 'Сертификаты — галерея (изображение 9 URL)',
    type: 'short',
    text: '',
  },
  {
    page: 'certificates',
    key: 'certificates.gallery.image9.alt',
    label: 'Сертификаты — галерея (изображение 9 alt)',
    type: 'short',
    text: 'Сертификат 9',
  },
  {
    page: 'certificates',
    key: 'certificates.gallery.image10.src',
    label: 'Сертификаты — галерея (изображение 10 URL)',
    type: 'short',
    text: '',
  },
  {
    page: 'certificates',
    key: 'certificates.gallery.image10.alt',
    label: 'Сертификаты — галерея (изображение 10 alt)',
    type: 'short',
    text: 'Сертификат 10',
  },
  {
    page: 'certificates',
    key: 'certificates.gallery.image11.src',
    label: 'Сертификаты — галерея (изображение 11 URL)',
    type: 'short',
    text: '',
  },
  {
    page: 'certificates',
    key: 'certificates.gallery.image11.alt',
    label: 'Сертификаты — галерея (изображение 11 alt)',
    type: 'short',
    text: 'Сертификат 11',
  },
  {
