  ...
  return (
    <button
      ...
      className={cn(
        ...
        iconOnly ? 'h-9 w-9 p-0 2xl:h-11 2xl:w-11 3xl:h-12 3xl:w-12' : 'px-3 py-2 min-h-[36px] 2xl:min-h-[42px] 2xl:text-base',
        isInWishlist
    ...
    >
      <svg className={cn('h-4 w-4 2xl:h-5 2xl:w-5', isInWishlist && 'fill-current')} viewBox="0 0 24 24" fill="none" aria-hidden>
        <path
      ...
      {!iconOnly && (
        <span className="ml-2 hidden sm:inline desktop-microtext-scale">
