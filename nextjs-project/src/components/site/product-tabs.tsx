...
function characteristicTableClasses(isSprintTheme: boolean): string {
  return cn(
    ...
    'max-sm:[&_table.product-characteristics-table]:block',
    'max-sm:[&_table.product-characteristics-table>tbody]:block',
    'max-sm:[&_table.product-characteristics-table>tbody>tr]:grid',
    'max-sm:[&_table.product-characteristics-table>tbody>tr]:grid-cols-1',
    'max-sm:[&_table.product-characteristics-table>tbody>tr]:gap-1',
    'max-sm:[&_table.product-characteristics-table>tbody>tr]:border-b',
    isSprintTheme
      ? 'max-sm:[&_table.product-characteristics-table>tbody>tr]:border-slate-700'
      : 'max-sm:[&_table.product-characteristics-table>tbody>tr]:border-gray-200 dark:max-sm:[&_table.product-characteristics-table>tbody>tr]:border-gray-700',
    ...
    '[&_table.product-characteristics-table th]:align-top',
    '[&_table.product-characteristics-table th]:whitespace-normal',
    '[&_table.product-characteristics-table th]:break-words',
    'max-sm:[&_table.product-characteristics-table th]:block',
    'max-sm:[&_table.product-characteristics-table th]:w-full',
    'max-sm:[&_table.product-characteristics-table th]:px-0',
    'max-sm:[&_table.product-characteristics-table th]:pb-0',
    '[&_table.product-characteristics-table td]:align-top',
    ...
    'max-sm:[&_table.product-characteristics-table td]:block',
    'max-sm:[&_table.product-characteristics-table td]:px-0',
    'max-sm:[&_table.product-characteristics-table td]:pt-0',
    isSprintTheme
      ? [
    ...
    'max-sm:[&_table[data-product-characteristics="1"]]:block',
    'max-sm:[&_table[data-product-characteristics="1"]>tbody]:block',
    'max-sm:[&_table[data-product-characteristics="1"]>tbody>tr]:grid',
    'max-sm:[&_table[data-product-characteristics="1"]>tbody>tr]:grid-cols-1',
    'max-sm:[&_table[data-product-characteristics="1"]>tbody>tr]:gap-1',
    'max-sm:[&_table[data-product-characteristics="1"]>tbody>tr]:border-b',
    isSprintTheme
      ? 'max-sm:[&_table[data-product-characteristics="1"]>tbody>tr]:border-slate-700'
      : 'max-sm:[&_table[data-product-characteristics="1"]>tbody>tr]:border-gray-200 dark:max-sm:[&_table[data-product-characteristics="1"]>tbody>tr]:border-gray-700',
    ...
    '[&_table[data-product-characteristics="1"] th]:align-top',
    '[&_table[data-product-characteristics="1"] th]:whitespace-normal',
    '[&_table[data-product-characteristics="1"] th]:break-words',
    'max-sm:[&_table[data-product-characteristics="1"] th]:block',
    'max-sm:[&_table[data-product-characteristics="1"] th]:w-full',
    'max-sm:[&_table[data-product-characteristics="1"] th]:px-0',
    'max-sm:[&_table[data-product-characteristics="1"] th]:pb-0',
    '[&_table[data-product-characteristics="1"] td]:px-4',
    '[&_table[data-product-characteristics="1"] td]:py-3',
    '[&_table[data-product-characteristics="1"] td]:align-top',
    ...
    'max-sm:[&_table[data-product-characteristics="1"] td]:block',
    'max-sm:[&_table[data-product-characteristics="1"] td]:px-0',
    'max-sm:[&_table[data-product-characteristics="1"] td]:pt-0',
    isSprintTheme
      ? [
