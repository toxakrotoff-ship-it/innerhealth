  ...
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        /** Hero/dark background: filled */
        heroPrimary:
          "bg-white/25 text-white border border-white/25 hover:bg-white/35 hover:border-white/40 transition-[background-color,border-color] duration-300 ease-out",
        /** Hero/dark background: outline */
        heroOutline:
          "bg-transparent text-white border border-white/25 hover:bg-white/10 hover:border-white/40 transition-[background-color,border-color] duration-300 ease-out",
      },
      size: {
...
const HERO_VARIANTS = ["heroPrimary", "heroOutline"] as const

function isHeroVariant(
  v: LiquidButtonProps["variant"]
): v is (typeof HERO_VARIANTS)[number] {
  return v != null && HERO_VARIANTS.includes(v as (typeof HERO_VARIANTS)[number])
}
...
const LiquidButton = React.forwardRef<HTMLButtonElement, LiquidButtonProps>(
  (
    ...
    const useSimpleBorder = isHeroVariant(variant)
      ...
      return (
        <>
          {React.cloneElement(child, {
            ...
            children: (
              <>
                {!useSimpleBorder && liquidButtonInner}
...
/** Metal 3D-style button with color variants */
type ColorVariant =
  | "default"
  | "primary"
  | "success"
