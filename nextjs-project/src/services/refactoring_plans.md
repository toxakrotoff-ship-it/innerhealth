> **Примечание (19.03.2026):** черновые промпты для Cursor. Формальные планы и статус — в репозитории `docs/plans/` и `docs/STATUS.md`. Часть пунктов уже реализована (сервисы, 2FA, валидация).
